                ...
                <div class="card-body border-bottom py-3">						
					...
					<?php } ?>														
                                    ...
                                    <td> 													
                                        ...
                                        <button class="btn btn-success btn-icon activate-company" data-id="<?php echo $crow['com_id']; ?>" title="Activate Company">    
...
$(document).on('click', '.activate-company', function () {
    ...
    Swal.fire({
        ...
        text: 'This company account will be activated.',
        icon: 'question',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: 'includes/companies/activate-company.php',
                type: 'POST',
                data: { com_id: com_id },
