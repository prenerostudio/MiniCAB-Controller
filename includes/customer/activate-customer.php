...
if ($stmt->execute()) {
    // Log deletion
    $activity_type = 'Customer Profile Activated';
    $user_type = 'user';
    $details = "Customer Profile ID #$c_id has been Activated by Controller.";
    ...
    echo json_encode(["status" => "success", "message" => "Customer profile has been Activated successfully."]);
} else {
