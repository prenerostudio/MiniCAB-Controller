...
$(document).ready(function() {
    ...
    $('#modal-customer-delete').on('show.bs.modal', function (event) {
        ...
        customerId = button.data('c_id'); // store id
    });

    $('#deleteCustomerBtn').on('click', function() {
        if (customerId) {
            $.ajax({
                url: 'includes/booker/del-booker.php',
                type: 'GET',
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">     
        <div class="modal-content">         
            ...
            <div class="modal-footer">             
                ...
                <button type="button" class="btn ms-auto btn-danger" id="deleteCustomerBtn"> Yes </button>                 
            </div>                           
        </div>             
    </div> 
</div>
...
<div class="modal modal-blur fade" id="modal-booker" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">    	
        <div class="modal-content">        			
            ...
            <div class="modal-body">		
                <form method="post" action="includes/booker/booker-process.php" enctype="multipart/form-data" onsubmit="return validateForm();">		
                    <div class="row">						
