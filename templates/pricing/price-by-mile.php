            ...
            <div class="card-body">
                ...
                <table class="table table-responsive">    
                    ...
                    <tbody>        
                        ...
                        $range_sql = mysqli_query($connect, "SELECT DISTINCT from_miles, to_miles FROM vehicle_pricing_miles ORDER BY from_miles ASC");        
                        ...
                        // Step 3: Fetch actual prices for the range
                            $sql = "SELECT v.v_name, vp.price_per_mile FROM vehicle_pricing_miles vp INNER JOIN vehicles v ON vp.v_id = v.v_id WHERE vp.from_miles = '$from' AND vp.to_miles = '$to'";            
...
<!--                                <a class="btn btn-info button_padding" href="edit-price.php?from=<?php echo $from; ?>&to=<?php echo $to; ?>">                        
                                ...
                                <a class="btn btn-danger button_padding" href="del-price-mile.php?from=<?php echo $from; ?>&to=<?php echo $to; ?>">                        
