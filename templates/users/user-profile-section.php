<div class="col-12">                    
    <div class="card-body">    
        ...
        <div class="row align-items-center">        
            ...
            <div class="col-auto">			            
                <form action="includes/users/update-user-thumbnail.php" method="post" enctype="multipart/form-data">				                
            ...
            <div class="col-auto">			            
                <a href="includes/users/del-user-img.php?user_id=<?php echo $urow['user_id'] ?>" class="btn btn-ghost-danger">                
                    Delete avatar
                </a>		                               
            </div>                       
        </div>        
        <h3 class="card-title mt-4">Business Profile</h3>        
        <form method="post" action="update-user-details.php">        
            <div class="row g-3">            
                <div class="col-md">                
