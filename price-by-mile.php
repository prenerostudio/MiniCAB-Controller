                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="background: #FFFFFF; color: #3A3A3A;">
                                <p align="center">
                                    <span>1-4 Seater</span>
                                    <br>Executive Salon  /<strong style="font-weight: 800"> Mile</strong>
                                </p>
                            </th>
                            <th style="background: #FFFFFF; color: #3A3A3A;">
                                <p align="center">
                                    <span>8-9 Seater</span>
                                    <br>Large MPV  /<strong style="font-weight: 800"> Mile</strong>
                                </p>
                            </th>
                            <th style="background: #FFFFFF; color: #3A3A3A;">
                                <p align="center">
                                    <span>8-9 Seater</span>
                                    <br>Executive Large MPV  /<strong style="font-weight: 800"> Mile</strong>
                                </p>
                            </th>
                            <th style="background: #FFFFFF; color: #3A3A3A;">
                                <p align="center"
                                   ><span>10-14 Seater</span>
                                    <br>MiniBus  /<strong style="font-weight: 800"> Mile</strong>
                                </p>
                            </th>
                            <th style="background: #FFFFFF; color: #3A3A3A;">
                                <p align="center">
                                    <span>Parcel</span>
                                    <br>Courier / Delivery  /<strong style="font-weight: 800"> Mile</strong>
                                </p>
                            </th>
                            <th></th>
                        </tr>
