...
INSERT INTO `drivers` (`d_id`, `d_name`, `d_email`, `d_phone`, `d_password`, `d_address`, `d_post_code`, `d_pic`, `d_gender`, `d_language`, `licence_authority`, `d_licence`, `d_licence_exp`, `pco_licence`, `pco_exp`, `latitude`, `longitude`, `status`, `acount_status`, `driver_reg_date`) VALUES
(1, 'Azib Ali', 'eurodatatechnology@gmail.com', '+447552834179', 'asdf1234', 'london uk new#485 new uk', '', '../../img/drivers/1000046675.jpg', 'Male', 'English', 'London', '4858595959533', '09/09/2024', '0485858595', '09/09/2025', '31.4414005', '73.0886402', 'On Ride', 1, '2024-02-25 04:19:09');
...
--
ALTER TABLE `driver_documents`
  MODIFY `dd_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
