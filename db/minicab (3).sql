...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2023 at 06:32 PM
...
(1, 00000000001, 1, 1, '', 250, 30, 20, 0, 100, 0, 'waiting', '2023-12-30 22:04:55');
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_id` int(55) NOT NULL AUTO_INCREMENT;
