...
(00000001, 00000006, 00000000, 'Draycott, Derby, UK', '', 'Northampton, UK', 'Dover, UK', 'Dundee DD1, UK', 2, '2025-06-11', '09:01:00', 'Return', 00000002, '2', 'Yes', '', '00:00:00', '', 1545, 103, 0, 0, 0, 0, 0, 0, 'Pending', 0, '0000-00-00', '00:00:00', '', '', 'Atiq', 'hello@prenero.com', '+923157524000', '0000-00-00 00:00:00'),
(00000002, 00000006, 00001001, 'London, UK', '', 'Birmingham, UK', 'London N13, UK', 'London N13, UK', 2, '2025-06-11', '14:05:00', 'Return', 00000002, '2', 'Yes', '', '00:00:00', '', 3260, 207, 0, 0, 0, 0, 0, 0, 'Pending', 1, '2025-06-12', '15:40:00', 'Bid Note', '', 'Azib Ali', 'azibalibutt@gmail.com', '+449231575240', '0000-00-00 00:00:00');
...
(00000003, 00000005, 00000002, '', '', '', '', '', '', '', '', '', '', '2025-06-10 16:00:26'),
...
(00000001, 00000000001, 00000000000, 00000000002, '', 0, 0, 0, 0, 0, 0, 'waiting', 0, '', '', '', '', '', '0000-00-00 00:00:00', '', '', '2025-06-04 05:22:10');
...
--
ALTER TABLE `activity_log`
  MODIFY `log_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `bids_notifications`
  MODIFY `bn_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `bookings_history`
  MODIFY `book_history_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `user_page_access`
  MODIFY `access_id` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
