...
CREATE TABLE `bookings` (
  ...
  `is_bid` int(55) NOT NULL,
  `bid_status` varchar(55) NOT NULL,
...
INSERT INTO `bookings` (`book_id`, `c_id`, `pickup`, `destination`, `passenger`, `luggage`, `note`, `book_date`, `book_time`, `journey_type`, `v_id`, `is_bid`, `bid_status`, `booking_status`, `date_added`) VALUES
(1, 1, 'Faisalabad', 'Lahore', 2, 'Yes', 'N/A', '2023-10-11', '15:00:00', 'One Way', 5, 0, '', 'Pending', '2023-10-10 05:55:48'),
(2, 1, 'Faisalabad', 'Lahore', 4, 'No', 'N/A', '2023-10-12', '18:06:00', 'One Way', 3, 0, '', 'Pending', '2023-10-10 05:56:36'),
(3, 1, 'Faisalabad', 'Lahore', 2, 'Yes', 'N/A', '2023-10-12', '17:05:00', 'Return', 3, 0, '', 'Pending', '2023-10-10 05:57:54'),
(4, 1, 'Faisalabad', 'Lahore', 2, 'Yes', 'Be on time', '2023-10-27', '05:00:00', 'Return', 3, 0, '', 'Pending', '0000-00-00 00:00:00'),
(5, 1, 'Faisalabad', 'Lahore', 2, 'Yes', 'N/A', '2023-10-07', '05:25:00', 'One Way', 3, 0, '', 'Pending', '2023-10-07 08:23:29'),
(7, 1, 'Faisalabad', 'Lahore', 4, 'Yes', 'N/A', '2023-10-26', '22:40:00', 'One Way', 3, 0, '', 'Pending', '2023-10-11 12:39:10');
...
INSERT INTO `booking_bid` (`bid_book_id`, `book_id`, `bid_status`, `date_added`) VALUES
(1, 4, 'Open', '2023-10-07 07:06:54'),
(2, 2, 'Open', '2023-10-07 07:06:54');
...
INSERT INTO `drivers` (`d_id`, `d_name`, `d_email`, `d_password`, `d_phone`, `d_address`, `d_pic`, `d_gender`, `d_language`, `v_id`, `d_licence`, `d_licence_exp`, `pco_licence`, `pco_exp`, `skype_acount`, `d_remarks`, `latitude`, `longitude`, `status`, `reg_date`, `monthly_salary`) VALUES
(1, 'Atiq Ramzan', 'hello@prenero.com', 'b743c33627755c255938a992d3480cab', '+923157524000', 'FSD ', 'img/drivers/20181017165737_IMG_6166.png', 'Male', 'English', 1, '123456789', '2023-10-28', '123456789', '2023-10-31', '', 'N/A', '51.52145727821898', '-0.12723122456155755', 'online', '2023-10-17 01:25:51', 0.00),
(2, 'Mahtab Mukhtar', 'nahtab@prenero.com', '25d55ad283aa400af464c76d713c07ad', '03241524624', 'Faisalabad, Punjab, Pakistan.', 'img/drivers/20181017165737_IMG_6166.png', 'Male', 'English', 1, '123456789', '2023-10-28', '123456789', '2023-10-31', '', 'N/A', '51.512474660272886', '-0.10759970050199483', 'online', '2023-10-10 04:40:14', 0.00),
(3, 'Shahzib', 'shazaib@prenero.com', '$2y$10$CfNmmVlmMeLt6S/F2/Q9IuZvsfXNf./4StlhOEPjiQ2NYtcaljKGC', '+44125364585', '', 'img/drivers/20181017165737_IMG_6166.png', 'Male', 'English', 16, '12345678', '2023-10-28', '123456789', '2023-10-31', 'atiq.ramzan98', 'N.A', '51.512474660272886', '-0.13759970050199483', 'New', '2023-10-20 13:52:41', 0.00);
...
INSERT INTO `jobs` (`job_id`, `book_id`, `c_id`, `d_id`, `fare`, `note`, `job_status`, `date_added`) VALUES
...
INSERT INTO `vehicles` (`v_id`, `d_id`, `v_name`, `v_seat`, `v_bags`, `v_wchair`, `v_trailer`, `v_booster`, `v_baby`, `v_pricing`, `v_img`, `date_added`) VALUES
(1, 1, 'Toyota Prius', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(2, 1, 'Hackney carriage', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(3, 1, 'Ford Galaxy', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(4, 1, 'Škoda Octavia', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(5, 1, 'Ford Crown Victoria', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(6, 1, 'Ford Mondeo', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(7, 1, 'Škoda Superb', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(8, 2, 'Toyota Camry', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '40', '', '2023-10-17 19:39:57'),
(9, 2, 'Citroen Berlingo', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(10, 2, 'Mercedes C', '8', 'yes', 'yes', 'yes', 'yes', 'yes', '250', '', '2023-10-17 19:39:57'),
(11, 2, 'Nissan NV200', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(12, 2, 'Volkswagen Touran', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '120', '', '2023-10-17 19:39:57'),
(13, 2, 'Hansom cab', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(14, 3, 'Toyota Crown', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(15, 3, 'Toyota HiAce', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(16, 3, 'BYD e6', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(17, 3, 'Hyundai Ioniq', '4', 'yes', 'yes', 'yes', 'yes', 'yes', '50', '', '2023-10-17 19:39:57'),
(18, 3, 'Honda Civic', '4', 'Yes', NULL, NULL, NULL, 'Yes', '50', 'img/vehicles/20190205_172610.jpg', '2023-10-21 20:03:32');
...
--
ALTER TABLE `booking_bid`
  MODIFY `bid_book_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `driver_payments`
  ADD CONSTRAINT `driver_payments_ibfk_1` FOREIGN KEY (`d_id`) REFERENCES `drivers` (`d_id`);
COMMIT;
