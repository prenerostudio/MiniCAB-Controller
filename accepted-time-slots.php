					...
					<div class="table-responsive">            										
						<table class="table table-responsive" id="slots">						
							...
							<tbody> 													
								<?php								
								$n=0;								
								$atsql=mysqli_query($connect,"SELECT time_slots.*, drivers.* FROM time_slots LEFT JOIN drivers ON time_slots.d_id = drivers.d_id WHERE time_slots.at_status = 1 ORDER BY time_slots.at_id DESC");
