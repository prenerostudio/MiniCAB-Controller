...
if (isset($_POST['d_id'])) {
    ...
    $sql = "SELECT SUM(invoice.total_pay) AS total_amount
            FROM invoice 
    ...
    if (!$result) {
        ...
        if ($total_amount !== null) {
            echo json_encode(array('total_amount' => $total_amount, 'status' => true, 'message' => "Total amount of invoices for the last week fetched successfully"));
        } else {
