...
if(isset($_POST['job_id'])){ 	
    ...
    if($chkr && mysqli_num_rows($chkr) > 0){
        ...
        $sql="INSERT INTO `invoice`(`job_id`, `c_id`, `d_id`, `journey_fare`, `car_parking`, `waiting`, `tolls`, `extra`, `total_pay`, `driver_commission`, `invoice_status`, `invoice_date`) VALUES ('$job_id', '$c_id', '$d_id', '$journey_fare', '$car_parking', '$waiting', '$tolls', '$extra', '$total_pay', '$driver_commission', '$status', '$date')";						
