...
if ($d_id) {
    ...
    if ($chkr && mysqli_num_rows($chkr) > 0) {
        ...
        $sql = "INSERT INTO `driver_vehicle` (`v_id`, `d_id`, `v_make`, `v_model`, `v_color`, `v_reg_num`, `v_phv`, `v_phv_expiry`, `v_ti`, `v_ti_expiry`, `v_mot`, `v_mot_expiry`, `date_v_add`) VALUES ('$v_id', '$d_id', '$v_make', '$v_model', '$v_color', '$v_reg_num', '$v_phv', '$v_phv_expiry', '$v_ti', '$v_ti_expiry', '$v_mot', '$v_mot_expiry', '$date')";
