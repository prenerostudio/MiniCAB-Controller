...
if ($fetch && $fetch->num_rows > 0) {
    ...
    $query = "UPDATE `vehicle_insurance` SET `vi_num`='$vi_num',`vi_exp`='$vi_exp', `vi_exp_time` = '$vi_exp_time',  `vi_img`='$vi_img',`vi_updated_at`='$date_update' WHERE `d_id` = '$d_id'";
} else {
    // Insert new record
    $query = "INSERT INTO `vehicle_insurance`(`d_id`, `vi_num`, `vi_exp`, `vi_exp_time`, `vi_img`, `vi_created_at`) VALUES ('$d_id','$vi_num','$vi_exp', '$vi_exp_time', '$vi_img','$date_update')";
}
