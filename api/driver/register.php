...
if (isset($_POST['d_name'], $_POST['d_email'], $_POST['d_phone'], $_POST['d_password'])) {
    ...
    // Insert new driver
    $stmt = $connect->prepare("INSERT INTO `drivers`(`d_name`, `d_email`, `d_phone`, `d_password`, `d_shift`, `d_pco`, `acount_status`, `signup_type`,`driver_reg_date`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssiis", $d_name, $d_email, $d_phone, $d_password, $d_shift, $d_pco, $acount_status, $signup_type, $date_update);
