        ...
        try {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($updateStmt->execute()) {
                    logActivity('Address Proofs Updated', 'driver', $d_id, "Address Proofs of Driver $d_id have been updated by Controller.");
                } else {
                ...
                if ($insertStmt->execute()) {
                    logActivity('Address Proofs Added', 'driver', $d_id, "Address Proofs of Driver $d_id have been added by Controller.");
                } else {
