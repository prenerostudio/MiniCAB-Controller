        ...
        <div class="card card-lg">        
            ...
            <div class="card-body">            
				...
				<?php echo $irow['d_name']; ?><br>                      
                    ...
                    <div class="col-6 text-end">					 
                        ...
                        <h2 style="text-transform: uppercase;">
                            ...
                            Status: <?php echo $irow['invoice_status'] ?>
                ...
                <table class="table table-transparent table-responsive">                 
					...
					<?php echo $irow['pick_date']; ?> - <?php echo $irow['pick_time']; ?>
                            ...
                            <div class="text-secondary">
                                ...
                                Drop-off: <?php echo $irow['destination']; ?>
                        ...
                        <td class="text-center">
                            ...
                            £ <?php echo $irow['car_parking']; ?>
			
                        </td>                   
			
                        <td class="text-center">
			
                            £ <?php echo $irow['waiting']; ?>
                    ...
                    <tr>                    
                        ...
                        <td colspan="7" class="strong text-end">
			...
			<?php        					       
                    ...
                    <tr>                   
                        ...
                        <td class="text-end">
                            ...
                            £ <?php echo number_format($driverCommission, 2); ?>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="font-weight-bold text-uppercase text-end">
