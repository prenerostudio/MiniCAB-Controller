	...
	<div class="row g-2 align-items-center">        	
		<div class="col">            								
			...
			<div class="btn-list">                			
				...
				<a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-new-driver" aria-label="Create new report">                    				
...
----------Add New Driver-------------
-------------------------------->
<div class="modal modal-blur fade" id="modal-new-driver" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">    	
		<div class="modal-content">        		
			<div class="modal-header">            			
				<h5 class="modal-title">Add New Driver</h5>            				
