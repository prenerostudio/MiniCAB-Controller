                                    ...
                                    <div id="table-ndriver" class="table-responsive">
                                        ...
                                        <table class="table" id="table-new">
                                            ...
                                            <tbody class="table-tbody">                            
                                                ...
                                                $ndsql = mysqli_query($connect, "SELECT d.*
FROM drivers d
WHERE NOT EXISTS (SELECT 1 FROM driving_license dl WHERE dl.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM dvla_check dc WHERE dc.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM address_proofs ap WHERE ap.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM pco_license pl WHERE pl.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM national_insurance ni WHERE ni.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM driver_extras de WHERE de.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_log_book vlb WHERE vlb.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_mot vm WHERE vm.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_insurance vi WHERE vi.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_pco vpc WHERE vpc.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_pictures vp WHERE vp.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_road_tax vrt WHERE vrt.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM rental_agreement ra WHERE ra.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_ins_schedule vis WHERE vis.d_id = d.d_id)
  AND NOT EXISTS (SELECT 1 FROM vehicle_extras ve WHERE ve.d_id = d.d_id);
");                            
