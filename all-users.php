                            ...
                            <tbody class="table-tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <button class="btn btn-danger delete-user-btn" data-uid="<?php echo $urow['user_id']; ?>" title="Delete">    
...
$(document).ready(function() {
    $('.delete-user-btn').click(function() {
        ...
        const row = $(this).closest('tr'); // optional: remove row dynamically later
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'includes/users/del-user.php',
                    type: 'POST',
