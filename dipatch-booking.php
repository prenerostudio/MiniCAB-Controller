						...
						<div class="row g-3">                						
							...
							<div class="col-md-6">							
								...
								<div class="mb-3 col-md-6">                    														
									...
									?>
									<option value="<?php echo $drrow['d_id'] ?>"><?php echo $drrow['d_name'] ?></option>
								<?php
									}
										?>
								...
								<div class="mb-3  col-md-6">                    														
									<div class="form-label">Extra Drop Charges</div>  								
									<input type="text" class="form-control" name="edc">
								</div>
									
									</div>
								<div class="row">
								<div class="mb-3 col-md-6">                    														
									<div class="form-label">Driver Waiting Charges</div>  								
									<input type="text" class="form-control" name="dwc">
								</div>
