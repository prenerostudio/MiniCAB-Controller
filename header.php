    ...
    <head>    	
        ...
        <script>
            (g => {
                ...
                c = "google", l = "importLibrary", m = document,
                b = window;    
                b = b[c] || (b[c] = {});    
                ...
                h = new Promise(resolve => {      
                    ...
                    e.set("key", "AIzaSyDIXJnumkmR2VgtJxN3v7zws24IwvpRrsI"); // 🔑 replace with your real key      
                        ...
                        <div class="navbar-nav flex-row order-md-last">                                                         
                            <div class="nav-item d-none d-md-flex me-3">                                    
                                <div class="btn-list">                                            
                                    ...
                                    <?php if (!empty($_SESSION['web_driver'])): ?>                                                   
                                    ...
                                    <?php endif; ?>                                                                                        
                                    <?php if (!empty($_SESSION['new_driver'])): ?>                                                   
                                    ...
                                    <?php endif; ?>                                                                                        
                                    <?php if (!empty($_SESSION['fare_corrections'])): ?>                                                   
                                    ...
                                    <?php endif; ?>                                                                                         
                                    <?php if (!empty($_SESSION['driver_tracker'])): ?>                                                   
                                    <a href="driver-tracker.php" class="btn btn-cyan">                    
                                       <i class="ti ti-user-search"></i>                    
                                       Driver Tracker                
                                   </a>            
                                    <?php endif; ?>                                                      
                                    <?php if (!empty($_SESSION['add_booking'])): ?>                                                   
                               ...
                               <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        fetch('includes/drivers/new-drivers-count.php')
                                    ...
                                    document.addEventListener("DOMContentLoaded", function() {
                                        fetch('includes/drivers/web-driver-count.php')
                                            ...
                                            .catch(error => console.error('Error fetching web driver count:', error));
                                    });

                                    document.addEventListener("DOMContentLoaded", function() {
                                        fetch('includes/drivers/fare-count.php')
                                            .then(response => response.json())
                                            .then(data => {
