                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">                            
                                ...
                                <div class="col-lg-12">	                                
                                    <div class="row">                                    
                                        <div class="mb-3 col-lg-4">                                        
                                            ...
                                            <input type="text" id="pickup1" name="pickup" class="form-control" placeholder="Select pickup location" required>                                        
                                        </div>                                        
                                        <div class="mb-3 col-lg-4">                                        
                                            <label class="form-label">Drop-off Location (Full Address):</label>                                            
                                            <input type="text" id="dropoff1" name="dropoff" class="form-control" placeholder="Select drop-off location" required>
                                        </div>
                                        <div class="col-lg-4">
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="pc1" name="postal_code">                                    
                                </div>
                                <div class="mb-3 col-lg-4">
