...
<script>	
	document.addEventListener("DOMContentLoaded", function() {    		
		const list = new List('table-default', {      					
			...
			valueNames: [ 'sort-id', 'sort-date', 'sort-time', 'sort-fare', 'sort-passenger', 'sort-status', 'sort-vehicle', 'sort-driver']
		}); 			
	})	
</script>
<?php	
