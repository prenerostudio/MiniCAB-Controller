		...
		<div class="card-body">                  			
			...
			<div class="tab-content">                   				
						...
						<div id="table-default" class="table-responsive">
							...
							<table class="table card-table table-vcenter text-nowrap datatable">                   					
								...
								<tbody> 						
									...
									$booksql=mysqli_query($connect,"SELECT booking_bid.*, clients.c_name, clients.c_email, clients.c_phone, bookings.* FROM booking_bid, bookings, clients WHERE booking_bid.book_id = bookings.book_id AND bookings.c_id = clients.c_id AND booking_bid.`bid_status` = 'Open'");
				...
				<table class="table card-table table-vcenter text-nowrap datatable">                   					
								...
								<tbody> 						
									<?php																											
									$booksql=mysqli_query($connect,"SELECT booking_bid.*, clients.c_name, clients.c_email, clients.c_phone, bookings.* FROM booking_bid, bookings, clients
