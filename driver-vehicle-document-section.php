<div class="card-body">
    <h2 class="mb-4">
        Driver Vehicle Document Section (All Documents with <span style="color:red;">*</span> are required.)
    </h2>	
    <div class="row mb-3">	
        <div class="col-md-6" style="border: 1px solid #6c7a91; padding: 30px;">		
            <h3 class="card-title">
                Vehicle Log Book <span style="color:red; font-size: 24px; font-weight: bold;">*</span> 
            </h3>
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <form action="upload-log-book.php" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6" style="border: 1px solid #6c7a91; padding: 30px;">			
            ...
            <div class="row align-items-center">				
                ...
                <div class="col-auto">
                    <form action="upload-mot.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="d_id" value="<?php echo $d_id; ?>">                       
                        <div class="form-group mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6" style="border: 1px solid #6c7a91; padding: 30px;">	
            ...
            <div class="row align-items-center">				
                ...
                <div class="col-auto">						
                    <form action="upload-vinsurance.php" method="post" enctype="multipart/form-data">		
                        <input type="hidden" name="d_id" value="<?php echo $d_id; ?>">	 
                        <div class="form-group mb-3">                        
    ...
    <div class="row mb-3">
        <div class="col-md-12" style="border: 1px solid #6c7a91; padding: 30px;">	
            ...
            <div class="row align-items-center">	
                ...
                <div class="col-auto">		
                    <form action="upload-vehicle-pictures.php" method="post" enctype="multipart/form-data">		
                        <input type="hidden" name="d_id" value="<?php echo $d_id; ?>">                         
                        <div class="form-group mb-3">                                                 
