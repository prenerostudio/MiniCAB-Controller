            ...
            <div class="card">				
                ...
                <div class="card-body border-bottom py-3">						
					...
					<?php                                        				
                                    ...
                                    <td>											
                                        <a href="includes/drivers/cancel-driver-delete.php?del_d_id=<?php echo $ddrow['del_d_id']; ?>" class="btn btn-danger" title="Cancelled">					
                                            <i class="ti ti-square-rounded-x"></i>					
                                        </a>					
                                        <a href="includes/drivers/approve-driver-delete.php?del_d_id=<?php echo $ddrow['del_d_id']; ?>" class="btn btn-success" title="Approve">					
