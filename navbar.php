        ...
        <div class="navbar">
            <div class="col">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-clock-24"></i></span>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php if ($completed_timeslot): ?><a class="dropdown-item" href="completed-time-slot.php"><i class="ti ti-clock-24"></i> Completed</a><?php endif; ?>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <?php if ($active_companies): ?><a class="dropdown-item" href="companies.php"><i class="ti ti-building-store"></i> Active Companies <?php include 'count-active-companies.php'; ?><span class="badge bg-green-lt ms-auto"><?php echo $active_company_count; ?></span></a><?php endif; ?>
                            <?php if ($blocked_companies): ?><a class="dropdown-item" href="blocked-companies.php"><i class="ti ti-users-group"></i> Blocked Companies <?php include 'count-block-company.php'; ?><span class="badge bg-red-lt ms-auto"><?php echo $block_company_count; ?></span></a><?php endif; ?>
                            <?php if ($deleted_companies): ?><a class="dropdown-item" href="#"><i class="ti ti-users-group"></i> Delete Requests <span class="badge bg-green-lt ms-auto">0</span></a><?php endif; ?>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-map-down"></i></span>
                            <span class="nav-link-title">Destinations</span>
                        </a>
                        <div class="dropdown-menu">
                            <?php if ($zones_list): ?><a class="dropdown-item" href="zones.php"><i class="ti ti-map-pins"></i> Zones <?php include 'count-zones.php'; ?><span class="badge bg-green-lt ms-auto"><?php echo $zone_count; ?></span></a><?php endif; ?>
                            <?php if ($airports_list): ?><a class="dropdown-item" href="airports.php"><i class="ti ti-plane-tilt"></i> Airports <?php include 'count-airports.php'; ?><span class="badge bg-green-lt ms-auto"><?php echo $ap_count; ?></span></a><?php endif; ?>
                            <?php if ($destinations_list): ?><a class="dropdown-item" href="destinations.php"><i class="ti ti-map-2"></i> Destinations <?php include 'count-dest.php'; ?><span class="badge bg-green-lt ms-auto"><?php echo $des_count; ?></span></a><?php endif; ?>
                            <?php if ($railways_list): ?><a class="dropdown-item" href="railway_stations.php"><i class="ti ti-train"></i> Railway Stations <?php include 'count-rs.php'; ?><span class="badge bg-green-lt ms-auto"><?php echo $rs_count; ?></span></a><?php endif; ?>
                        </div>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><i class="ti ti-credit-card-pay"></i></span>
                            <span class="nav-link-title">Accounts</span>
                        </a>
                        <div class="dropdown-menu">
                            <?php if ($driver_reports): ?><a class="dropdown-item" href="driver-reports.php"><i class="ti ti-report"></i> Driver Account Statement</a><?php endif; ?>
                            <?php if ($customer_reports): ?><a class="dropdown-item" href="customer-report.php"><i class="ti ti-report"></i> Customer Account Statement</a><?php endif; ?>
                            <?php if ($booker_reports): ?><a class="dropdown-item" href="booker-report.php"><i class="ti ti-report"></i> Booker Account Statement</a><?php endif; ?>
                        </div>
                    </li>
                    <?php endif; ?>
