                ...
                <div class="card-body border-bottom py-3">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" name="pickup" class="form-control" value="<?php echo htmlspecialchars($bookrow['pickup']); ?>" required>
                                </div>
                                <div class="mb-3 col-lg-4">
                                    <label class="form-label">Drop-off Location:</label>
                                    <input type="text" name="dropoff" class="form-control" value="<?php echo htmlspecialchars($bookrow['destination']); ?>" required>
                                </div>
                                <div class="col-lg-4">
                                    <div id="stops-container">										
                                        <?php 
                                        if (!empty($bookrow['stops'])):                                             
					...
					<?php } ?>					
                            ...
                            <div class="row">							
                                ...
                                <?php if( !empty($bookrow['booker_commission'])){ ?>				                                                              
                    ...
                    <div class="modal-body">
                        <div class="row">                        
                            ...
                            <table class="table table-responsive">
                                <tr>                                
                                    <td style="width: 25%;"><strong> Booking Type: </strong></td>                                
                                    <td style="width: 25%;"><strong> Customer Name: </strong></td>                                
                                    <td style="width: 25%;"><strong> Customer Phone: </strong></td>                                
                                    <td style="width: 25%;"><strong> Customer Email: </strong></td>                                        
                                </tr>
                                <tr>                                
                                    <td><?php echo $hbookrow['b_type_name'];?></td>                                
                                    <td><?php echo $hbookrow['c_name'];?></td>                                
                                    <td><?php echo $hbookrow['c_phone'];?></td>                                
                                    <td><?php echo $hbookrow['c_email'];?></td>
                                </tr>                                                                                       
                                <tr>                                    
                                ...
                                <tr>
                                    <td><?php echo $hbookrow['pickup'];?></td>                                
                                    <td><?php echo $hbookrow['destination'];?></td>                                
                                    <td><?php echo $hbookrow['stops'];?></td>                                
                                    <td> </td>
                                </tr>                                                        
                                <tr>
                                ...
                                <tr>
                                    <td><?php echo $hbookrow['address'];?></td>                                
                                    <td><?php echo $hbookrow['postal_code'];?></td>                                
                                    <td><?php echo $hbookrow['passenger'];?></td>                                
                                    <td><?php echo $hbookrow['journey_type'];?></td>
                                </tr>                                                                                   
                                <tr>                                
                                ...
                                <tr>
                                    <td><?php echo $hbookrow['pick_date'];?></td>                                
                                    <td><?php echo $hbookrow['pick_time'];?></td>                                
                                    <td><?php echo $hbookrow['luggage'];?></td>                                
                                    <td><?php echo $hbookrow['child_seat'];?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><?php echo $hbookrow['v_name'];?></td>                                
                                    <td><?php echo $hbookrow['flight_number'];?></td>                                
                                    <td><?php echo $hbookrow['delay_time'];?></td>                                
                                    <td><?php echo $hbookrow['journey_distance'];?></td>
                                </tr>                                                                                    
                                <tr>                                
                                    <td colspan="4"><strong> Special Note: </strong></td>
                                </tr>                                    
                                <tr>                                
                                    <td colspan="4"><?php echo $hbookrow['note'];?></td>
                                </tr>											
                                <tr>                                
                                    <td><strong> Booking Fee: </strong></td>                                
                                    <td><strong> Car Parking: </strong></td>                                
                                    <td><strong> Waiting Charges: </strong></td>                                
                                    <td><strong> Tolls Taxes: </strong></td>
                                </tr>                                                            
                                <tr>                                
                                    <td><?php echo $hbookrow['booking_fee'];?></td>                                
                                    <td><?php echo $hbookrow['car_parking'];?></td>                                
                                    <td><?php echo $hbookrow['waiting'];?></td>                                
                                    <td><?php echo $hbookrow['tolls'];?></td>
                                </tr>
                                <tr>
                                    <td><strong> Extra Charges: </strong></td>                                
                                    <td><strong> Journey Fare: </strong></td>                                
                                    <td><strong></strong></td>                                
                                    <td><strong></strong></td>
                                </tr>                            
                                <tr>                                
                                    <td><?php echo $hbookrow['extra'];?></td>                                
                                    <td><?php echo $hbookrow['journey_fare'];?></td>                                                                    
                                    <td></td>                                                                    
                                    <td></td>
                                </tr>
                            </table>
