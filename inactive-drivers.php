                ...
                <div class="card-body border-bottom py-3">
					...
					<?php endif; ?>
                                    ...
                                    <td>                                    				
                                        ...
                                        <a href="includes/drivers/del-driver.php?d_id=<?php echo $idrow['d_id']; ?>" class="btn btn-danger btn-icon delete_btn" title="Delete" onclick="return confirm('Are you sure you want to delete this driver?');">										   
                                            <i class="ti ti-square-rounded-x"></i>
					
                                        </a>
                                        <a href="includes/drivers/activate-driver.php?d_id=<?php echo $idrow['d_id']; ?>" class="btn btn-success btn-icon" title="Activate Driver">
