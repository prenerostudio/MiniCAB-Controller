        ...
        <div class="col-12">											
            <div class="card">						
                ...
                <div class="card-body border-bottom py-3">
                    <div>
                        <table class="table table-responsive" id="table-inactive">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Image</th>
					...
					<?php endif; ?>
                                    ...
                                    <td>                                    				
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-danger btn-icon deleteDriverBtn" data-did="<?php echo $idrow['d_id']; ?>" title="Delete Driver">   
