                        ...
                        <div class="modal-body">                                                 			
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pickup" name="zn" placeholder="Zone Name" required>				
                                </div>                                
                                <div class="mb-3">
                                    <label class="form-label">Latitude Minimum</label>
                                    <input type="text" class="form-control" name="lat_min" placeholder="00.000000000" required>				
                                </div>                                                                 
                                <div class="mb-3">
                                    <label class="form-label">Latitude Maximum</label>
                                    <input type="text" class="form-control" name="lat_max" placeholder="00.000000000" required>				
                                </div>                                
                                <div class="mb-3">
                                    <label class="form-label">Longitude Minimum</label>
                                    <input type="text" class="form-control" name="lng_min" placeholder="00.000000000" required>				
                                </div>                                
                                <div class="mb-3">
                                    <label class="form-label">Longitude Maximum</label>
                                    <input type="text" class="form-control" name="lng_max" placeholder="00.000000000" required>				
                                </div>				                                								                                          				
                            </div>
                        </div>			
