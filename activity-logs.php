                ...
                <div id="table-default" class="table-responsive">                  										
                    <table class="table" id="logs">												
                        ...
                        <tbody class="table-tbody">
                            ...
                            $y=0;
                            $actsql=mysqli_query($connect,"SELECT activity_log.*, users.* FROM activity_log JOIN users ON activity_log.user_id = users.user_id WHERE activity_log.user_type = 'user' AND activity_log.user_id = '$myId' ORDER BY activity_log.log_id DESC");
