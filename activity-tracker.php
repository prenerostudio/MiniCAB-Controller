<div class="card-body">
    ...
    // Set start and end points to default coordinates if no driver coordinates are available
...
<script>    
    function initMap() {         
        ...
        if (coordinates.length > 0) {
            ...
            // If there are no coordinates, center the map at the default London location
