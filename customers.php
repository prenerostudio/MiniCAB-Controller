                ...
                <div class="card-body border-bottom py-3">						
					...
					<?php
                                    ...
                                    <td>				
                                        ...
                                        <a href="includes/customer/del-customer.php?c_id=<?php echo $crow['c_id']; ?>" class="btn btn-danger btn-icon" title="Delete">                                            
...
<div class="modal modal-blur fade" id="modal-customer" tabindex="-1" role="dialog" aria-hidden="true">	
    <div class="modal-dialog modal-lg" role="document">    	
        <div class="modal-content">        			
            ...
            <form method="post" action="includes/customer/customer-process.php" enctype="multipart/form-data" onsubmit="return validateForm();">	
